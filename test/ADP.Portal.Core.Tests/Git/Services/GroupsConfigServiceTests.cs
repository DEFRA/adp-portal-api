...
public class GroupsConfigServiceTests
{
    ...
    public async Task SyncGroupsAsync_GroupsConfigIsNull_ReturnsErrorResult()
    {
        ...
        gitOpsConfigRepositoryMock.GetFileContentAsync<GroupsRoot>(Arg.Any<string>(), Arg.Any<GitRepo>()).Returns(groupsRoot);
    ...
    {
        // Arrange
        gitOpsConfigRepositoryMock.GetFileContentAsync<GroupsRoot>(Arg.Any<string>(), Arg.Any<GitRepo>())
    ...
    {
        // Arrange
        gitOpsConfigRepositoryMock.GetFileContentAsync<GroupsRoot>(Arg.Any<string>(), Arg.Any<GitRepo>()).Returns(new GroupsRoot() { Groups = [] });
    ...
    public async Task SetGroupMembersAsync_ConfigCreated()
    {
        ...
        gitOpsConfigRepositoryMock.GetFileContentAsync<GroupsRoot>(Arg.Any<string>(), Arg.Any<GitRepo>()).Returns(new GroupsRoot { Groups = groups.ToList() });
    ...
    {
        // Arrange
        gitOpsConfigRepositoryMock.GetFileContentAsync<GroupsRoot>(Arg.Any<string>(), Arg.Any<GitRepo>()).ReturnsNull();
        var members = fixture.Build<string>().CreateMany(2);
