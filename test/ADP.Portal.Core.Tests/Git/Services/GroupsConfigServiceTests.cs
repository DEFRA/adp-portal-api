...
public class GroupsConfigServiceTests
{
    ...
    {
        // Arrange
        gitOpsConfigRepositoryMock.CreateOrUpdateFileAsync(Arg.Any<GitRepo>(), Arg.Any<string>(), Arg.Any<string>()).Returns("sha");
    ...
    {
        // Arrange
        gitOpsConfigRepositoryMock.CreateOrUpdateFileAsync(Arg.Any<GitRepo>(), Arg.Any<string>(), Arg.Any<string>()).Returns(string.Empty);
        var members = fixture.Build<string>().CreateMany(2);
