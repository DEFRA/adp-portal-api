    ...
    public static class Constants
    {
        ...
        public static class Flux
        {
            ...
            public static class Templates
            {
                ...
                public const string PS_EXEC_DEFAULT_VERSION_TOKEN_VALUE = "__SSV_PLATFORM_ACR__.azurecr.io/image/powershell-executor:${POWERSHELL_EXECUTER_VERSION}#{\"$imagepolicy\":\"flux-config:powershell-executor-__ENVIRONMENT__-0__ENV_INSTANCE__\"}";
